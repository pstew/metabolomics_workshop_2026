...
- Let's look at data/20260604_SchwertzH_Data.xlsx
  ...
  - File names are important (and can contain important data)
  ...
  - Let's separate our row annotations to make a sheet that contains the meta data.
    ...
    - Save the resulting file with descriptive-name_date in data folder as a tab delimited text file.
